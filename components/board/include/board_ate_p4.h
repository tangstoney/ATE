...
#define BOARD_UART_INSTR_0_RX_BUF_SIZE       (1024U)
#define BOARD_UART_INSTR_0_TX_BUF_SIZE       (1024U)
...
#define BOARD_UART_INSTR_1_RX_BUF_SIZE       (1024U)
#define BOARD_UART_INSTR_1_TX_BUF_SIZE       (1024U)
#define BOARD_UART_INSTR_1_TIMEOUT_MS        (100U)

#define BOARD_UART_INSTR_2_PORT              UART_NUM_3
#define BOARD_UART_INSTR_2_TX                BOARD_GPIO_NONE
#define BOARD_UART_INSTR_2_RX                BOARD_GPIO_NONE
#define BOARD_UART_INSTR_2_RTS               BOARD_GPIO_NONE
#define BOARD_UART_INSTR_2_CTS               BOARD_GPIO_NONE
#define BOARD_UART_INSTR_2_BAUD_DEFAULT      CONFIG_BOARD_ATE_P4_INSTRUMENT_UART_BAUD_DEFAULT
#define BOARD_UART_INSTR_2_RX_BUF_SIZE       (1024U)
#define BOARD_UART_INSTR_2_TX_BUF_SIZE       (1024U)
#define BOARD_UART_INSTR_2_TIMEOUT_MS        (100U)

#define BOARD_UART_INSTR_3_PORT              UART_NUM_4
#define BOARD_UART_INSTR_3_TX                BOARD_GPIO_NONE
#define BOARD_UART_INSTR_3_RX                BOARD_GPIO_NONE
#define BOARD_UART_INSTR_3_RTS               BOARD_GPIO_NONE
#define BOARD_UART_INSTR_3_CTS               BOARD_GPIO_NONE
#define BOARD_UART_INSTR_3_BAUD_DEFAULT      CONFIG_BOARD_ATE_P4_INSTRUMENT_UART_BAUD_DEFAULT
#define BOARD_UART_INSTR_3_RX_BUF_SIZE       (1024U)
#define BOARD_UART_INSTR_3_TX_BUF_SIZE       (1024U)
#define BOARD_UART_INSTR_3_TIMEOUT_MS        (100U)

/* Legacy aliases: slot 0 remains the default instrument UART. */
#define BOARD_UART_INSTR_PORT                BOARD_UART_INSTR_0_PORT
#define BOARD_UART_INSTR_TX                  BOARD_UART_INSTR_0_TX
#define BOARD_UART_INSTR_RX                  BOARD_UART_INSTR_0_RX
#define BOARD_UART_INSTR_RTS                 BOARD_UART_INSTR_0_RTS
#define BOARD_UART_INSTR_CTS                 BOARD_UART_INSTR_0_CTS
#define BOARD_UART_INSTR_BAUD_DEFAULT        BOARD_UART_INSTR_0_BAUD_DEFAULT
#define BOARD_UART_INSTR_RX_BUF_SIZE         BOARD_UART_INSTR_0_RX_BUF_SIZE
#define BOARD_UART_INSTR_TX_BUF_SIZE         BOARD_UART_INSTR_0_TX_BUF_SIZE
#define BOARD_UART_INSTR_TIMEOUT_MS          BOARD_UART_INSTR_0_TIMEOUT_MS

...
static void event_handler_cb_page1_to_main(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_page1() {
    ...
    lv_obj_set_size(obj, 1280, 800);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 100, 50);
            lv_obj_add_event_cb(obj, event_handler_cb_page1_to_main, LV_EVENT_ALL, flowState);
            {
                lv_obj_t *parent_obj = obj;
                {
                    lv_obj_t *obj = lv_label_create(parent_obj);
...
static const char *object_names[] = { "main", "page1", "btn1", "to_main", "to_page1" };
